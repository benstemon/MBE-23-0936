...
outdir="/work/bs66/dasanthera_novaseq/analysis/pixyout-fullspecies"
popfile="/work/bs66/dasanthera_novaseq/analysis/pixyout-fullspecies/popfile_allpops-fullspecies.txt"
...
pixy --stats pi fst dxy \
 ...
 --output_prefix fullspecies_10kb
...
pixy --stats pi fst dxy \
 ...
 --n_cores 8 \
 --output_folder $outdir \
 --output_prefix fullspecies_50kb
