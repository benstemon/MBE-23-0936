...
#read in the file, which was prepared with shell script "DSTATS_4.generate_dstat_genic_plotfiles.sh"
...
save(finaldata, file = "fdm_vs_genic.obj")
...
#plot results
pdf("fdm_vs_genic_fraction.pdf", height = 6, width = 15)
ggplot(finaldata, aes(x = genic_fraction, y = absf_dM, group = speciescomp_fdM)) +
  geom_point(size = 0.6, alpha = 0.2) +
