...
#SBATCH --output=slurm-Dsuite_introtests_10kb_%a.out
#SBATCH --error=slurm-Dsuite_introtests_10kb_%a.error
...
popset="popset-fullspecies.txt"
trioset="trioset-fullspecies.txt"



#run Dsuite Dinvestigate
cd $dstat_outdir
Dsuite Dinvestigate -n 10kb -w 10000,2500 $invcf $popset $trioset
